  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-5xl px-6">
        ...
        <section id="prepare" className="py-20 border-t border-white/10">
            ...
            <div className="rounded-xl border border-white/15 bg-white/[0.03] p-6">
              ...
              <ul className="mt-4 space-y-2 text-sm">
                {osDownloads.map((o) => (
                  <li
                    key={o.env}
                    className="flex justify-between gap-4 text-slate-200"
                  >
                    <span>{o.env}</span>
                    <span className="text-slate-400 text-right">{o.file}</span>
                  </li>
                ))}
              </ul>
              <a
        ...
        <section className="py-20 border-t border-white/10">
          ...
          <div className="mt-4 rounded-xl border border-white/15 bg-white/[0.03] p-6">
        ...
        <section className="py-20 border-t border-white/10">
          ...
          <div className="mt-8 grid md:grid-cols-2 gap-4">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group block rounded-xl border border-white/15 bg-white/[0.03] p-6 hover:border-violet-400/60 hover:bg-white/5 transition"
            >
        ...
        <section id="start" className="py-20 border-t border-white/10">
          <h2 className="text-sm tracking-widest uppercase text-slate-400">
            B. 시작하기
          </h2>
          <h3 className="mt-4 text-3xl md:text-4xl font-bold tracking-tight">
          ...
          <div className="mt-10 space-y-16">
            {githubSteps.map((s, i) => (
              <div key={s.title}>
                ...
                <p className="mt-2 text-base text-slate-300 leading-relaxed max-w-2xl">
                  {s.desc}
                </p>
                {i === 3 && (
                  <pre className="mt-4 rounded-lg border border-white/15 bg-white/[0.03] bg-slate-950/60 p-4 text-sm text-slate-200 overflow-x-auto">
                    <code>{gitCommands}</code>
                  </pre>
                )}
                <div className="mt-5 rounded-xl border border-white/15 bg-white/[0.03] overflow-hidden bg-slate-950/60">
                  <Image
                    src={s.img}
                    alt={s.title}
        ...
        <section id="run" className="py-20 border-t border-white/10">
          <h2 className="text-sm tracking-widest uppercase text-slate-400">
            로컬에서 실행하기
          </h2>
          <h3 className="mt-4 text-3xl md:text-4xl font-bold tracking-tight">
...
- 반응형`}</code>
            ...
            <div className="rounded-xl border border-white/15 bg-white/[0.03] p-6">
              ...
              <pre className="mt-3 rounded-lg border border-white/15 bg-white/[0.03] bg-slate-950/60 p-4 text-sm text-slate-200 overflow-x-auto">
        ...
        <section id="deploy" className="py-20 border-t border-white/10">
          <h2 className="text-sm tracking-widest uppercase text-slate-400">
            배포하기
          </h2>
          <h3 className="mt-4 text-3xl md:text-4xl font-bold tracking-tight">
        ...
        <section className="py-20 border-t border-white/10">
          ...
          <div className="mt-10 space-y-4">
            ...
            <div className="rounded-xl border border-white/15 bg-white/[0.03] p-6">
              ...
              <p className="mt-3 text-sm text-slate-300">좋은 커밋 메시지 예시:</p>
              ...
              <p className="mt-3 text-xs text-slate-400">
                * &quot;수정&quot;, &quot;업데이트&quot; 같은 두루뭉술한 메시지보다{" "}
                <span className="text-slate-300">무엇을</span> 바꿨는지
                구체적으로 적는 게 좋습니다.
              </p>
            </div>
